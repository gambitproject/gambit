...
NormalEquSolver::NormalEquSolver(char *_matrix_file_name, double _l_start,
				 double _l_stop,double _dl,double _dp,
				 double _m_error,int _data_type,
				 char *out_file_name)
{
  update_func=NULL;
...
NormalEquSolver::NormalEquSolver(NormalMatrix _matrix,double _l_start,
				 double _l_stop,double _dl,double _dp,
				 double _m_error,int _data_type,char *out_file_name)
{
  update_func=NULL;
...
// Normal Matrix Class
//************************************************************************
NormalMatrix::NormalMatrix(int _dim) : dim(_dim)
{
  //  dim=_dim;
  assert(dim>0);
