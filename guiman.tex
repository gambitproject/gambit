...
games.  In order to cator to experienced users familiar with the 
...
currently loaded normal form, it will be greyed out in the dialog.  After an
...
checkbox.  The dominance type is controled by the radiobox.
\end{description}
...
nonterminal nodes get added to all of the terminal note outcomes descendant
from that node.
...
An aditional level of solution inspection is provided by the Node Inspect
