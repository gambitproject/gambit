...
{
if (nf.NumPlayers()!=2) {wxMessageBox("LCP algorithm only works on 2 player games.","Algorithm Error");}
...
if (nf.NumPlayers() > 2 || !IsConstSum(nf))
	{wxMessageBox("Only valid for two-person zero-sum games");return solns;}
