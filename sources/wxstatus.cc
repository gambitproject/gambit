    ...
    wxDialogBox(frame, (char *)title, FALSE, -1, -1, 300, 250)
{
    ...
    wxButton *cancel = new wxButton(this, (wxFunction)button_proc, 
                                    "Cancel", 100, 170, 100, 30);
