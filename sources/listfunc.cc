...
void Init_listfunc(GSM *gsm)
{
  ...
  FuncObj->SetParamInfo(GSM_LengthText, 0, "text", porSTRING, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);

  FuncObj = new FuncDescObj("NthElement");
  FuncObj->SetFuncInfo(GSM_NthElement, 2);
  FuncObj->SetParamInfo(GSM_NthElement, 0, "list", porALL | porLIST, NO_DEFAULT_VALUE);
  FuncObj->SetParamInfo(GSM_NthElement, 1, "n", porINTEGER, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);

  FuncObj = new FuncDescObj("Remove");
  FuncObj->SetFuncInfo(GSM_Remove, 2);
  FuncObj->SetParamInfo(GSM_Remove, 0, "list", porALL | porLIST, NO_DEFAULT_VALUE);
  FuncObj->SetParamInfo(GSM_Remove, 1, "n", porINTEGER, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);

  FuncObj = new FuncDescObj("NthChar");
  FuncObj->SetFuncInfo(GSM_NthChar, 2);
  FuncObj->SetParamInfo(GSM_NthChar, 0, "text", porSTRING, NO_DEFAULT_VALUE);
  FuncObj->SetParamInfo(GSM_NthChar, 1, "n", porINTEGER, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);

  FuncObj = new FuncDescObj("Text");
  FuncObj->SetFuncInfo(GSM_TextInt, 1);
  FuncObj->SetParamInfo(GSM_TextInt, 0, "x", porINTEGER, NO_DEFAULT_VALUE);

  FuncObj->SetFuncInfo(GSM_TextFloat, 1);
  FuncObj->SetParamInfo(GSM_TextFloat, 0, "x", porDOUBLE, NO_DEFAULT_VALUE);

  FuncObj->SetFuncInfo(GSM_TextRat, 1);
  FuncObj->SetParamInfo(GSM_TextRat, 0, "x", porRATIONAL, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);
  
  FuncObj = new FuncDescObj("Float");
  FuncObj->SetFuncInfo(GSM_FloatRational, 1);
  FuncObj->SetParamInfo(GSM_FloatRational, 0, "x", porRATIONAL, NO_DEFAULT_VALUE);

  FuncObj->SetFuncInfo(GSM_FloatInteger, 1);
  FuncObj->SetParamInfo(GSM_FloatInteger, 0, "x", porINTEGER, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);

  FuncObj = new FuncDescObj("Rational");
  FuncObj->SetFuncInfo(GSM_RationalFloat, 1);
  FuncObj->SetParamInfo(GSM_RationalFloat, 0, "x", porDOUBLE, NO_DEFAULT_VALUE);
  
  FuncObj->SetFuncInfo(GSM_RationalInteger, 1);
  FuncObj->SetParamInfo(GSM_RationalInteger, 0, "x", porINTEGER, NO_DEFAULT_VALUE);
  gsm->AddFunction(FuncObj);
