...
typedef enum {
  ...
  GBT_MENU_FILE_IMPORT = 107, 
  GBT_MENU_FILE_IMPORT_COMLAB = 108,
  ...
  GBT_MENU_VIEW_OUTCOMES = 302,
  GBT_MENU_VIEW_OUTCOME_LABELS = 303,
  GBT_MENU_VIEW_PROBABILITIES = 304,
  GBT_MENU_VIEW_PROFILES = 305,
  GBT_MENU_VIEW_SUPPORTS = 306,
  GBT_MENU_VIEW_SUPPORT_REACHABLE = 307,
  GBT_MENU_VIEW_VALUES = 308,
  GBT_MENU_VIEW_ZOOMIN = 309,
  GBT_MENU_VIEW_ZOOMOUT = 310,
  ...
  GBT_MENU_TOOLS_NFG = 503,
  GBT_MENU_TOOLS_NFG_AGENT = 504,
  GBT_MENU_TOOLS_NFG_REDUCED = 505,
  GBT_MENU_TOOLS_QRE = 506,

  GBT_MENU_PROFILES_DELETE = 600,
  GBT_MENU_PROFILES_DUPLICATE = 601,
  GBT_MENU_PROFILES_NEW = 602,
  GBT_MENU_PROFILES_PROPERTIES = 603,
  GBT_MENU_PROFILES_REPORT = 604,
