...
#ifndef GUI_NFGSUPPORT_H
#define GUI_NFGSUPPORT_H
...
private:
  gbtOrdMap<wxTreeItemId, gbtGameStrategy> m_map;
...
public:
  ...
  gbtGameStrategy GetStrategy(wxTreeItemId p_id) { return m_map(p_id); }
};
