...
public:
  ...
  double StartLambda(void) const
    { return ToNumber(gText(m_startLambda->GetValue().mb_str())); }
  double StopLambda(void) const
    { return ToNumber(gText(m_stopLambda->GetValue().mb_str())); }
  double StepLambda(void) const
    { return ToNumber(gText(m_stepLambda->GetValue().mb_str())); }

  double Del1(void) const
    { return ToNumber(gText(m_del1->GetValue().mb_str())); }
  double Tol1(void) const
    { return ToNumber(gText(m_tol1->GetValue().mb_str())); }
  double Del2(void) const
    { return ToNumber(gText(m_del2->GetValue().mb_str())); }
  double Tol2(void) const
    { return ToNumber(gText(m_tol2->GetValue().mb_str())); }
