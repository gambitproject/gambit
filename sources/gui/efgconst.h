...
typedef enum {
  ...
  efgmenuTOOLS_SUBGAME_COLLAPSE = 1356,
  efgmenuTOOLS_SUBGAME_COLLAPSEALL = 1358,
  efgmenuTOOLS_SUBGAME_EXPAND = 1360,
  efgmenuTOOLS_SUBGAME_EXPANDBRANCH = 1361,
  efgmenuTOOLS_SUBGAME_EXPANDALL = 1362,
