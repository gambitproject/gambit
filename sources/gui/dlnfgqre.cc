...
dialogNfgQre::dialogNfgQre(wxWindow *p_parent, const gbtNfgSupport &p_support)
  : wxDialog(p_parent, -1, _("Compute quantal response equilibria"),
	     wxDefaultPosition)
{
  SetAutoLayout(true);
  ...
  wxString solveChoices[] = { _("Trace principal branch"),
			      _("Use grid search") };
  m_solveUsing = new wxRadioBox(this, idRADIOBOX_SOLVEUSING, _("Method"),
  ...
  startLambdaSizer->Add(new wxStaticText(this, wxID_STATIC, 
					 _("Start at lambda")),
			0, wxALL | wxCENTER, 5);
  m_startLambda = new wxTextCtrl(this, -1, wxT(".01"));
  ...
  stopLambdaSizer->Add(new wxStaticText(this, wxID_STATIC, 
					_("Stop at lambda")),
		       0, wxALL | wxCENTER, 5);
  m_stopLambda = new wxTextCtrl(this, -1, wxT("3"));
  ...
  stepLambdaSizer->Add(new wxStaticText(this, wxID_STATIC, _("Increment by")),
		       0, wxALL | wxCENTER, 5);
  m_stepLambda = new wxTextCtrl(this, -1, wxT(".1"));
  ...
  coarseGridSizer->Add(new wxStaticText(this, wxID_STATIC, _("Grid size")),
			0, wxALL | wxCENTER, 5);
  m_del1 = new wxTextCtrl(this, -1, wxT(".01"));
  m_del1->Enable(false);
  ...
  coarseTolSizer->Add(new wxStaticText(this, wxID_STATIC, _("Tolerance")),
		      0, wxALL | wxCENTER, 5);
  m_tol1 = new wxTextCtrl(this, -1, wxT(".01"));
  m_tol1->Enable(false);
  ...
  wxStaticBox *fineBox = new wxStaticBox(this, wxID_STATIC,
					 _("Settings for fine grid"));
  wxStaticBoxSizer *fineSizer = new wxStaticBoxSizer(fineBox, wxVERTICAL);

  wxBoxSizer *fineGridSizer = new wxBoxSizer(wxHORIZONTAL);
  fineGridSizer->Add(new wxStaticText(this, wxID_STATIC, _("Grid size")),
		     0, wxALL | wxCENTER, 5);
  m_del2 = new wxTextCtrl(this, -1, wxT(".0001"));
  m_del2->Enable(false);
  ...
  fineTolSizer->Add(new wxStaticText(this, wxID_STATIC, _("Tolerance")),
		    0, wxALL | wxCENTER, 5);
  m_tol2 = new wxTextCtrl(this, -1, wxT(".0001"));
  m_tol2->Enable(false);
