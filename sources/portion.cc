...
{ 
  return new MixedValPortion<double>
...
{ 
  return new MixedValPortion<gRational>
...
{ 
  return new BehavValPortion<double>
...
{ 
  return new BehavValPortion<gRational>
