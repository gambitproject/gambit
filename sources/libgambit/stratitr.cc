...
StrategyIterator::StrategyIterator(const StrategySupport &p_support)
  : m_atEnd(false), m_support(p_support),
    ...
    m_profile(m_support.GetGame()), m_frozen1(0), m_frozen2(0)
{
  First();
}
...
StrategyIterator::StrategyIterator(const StrategySupport &p_support,
  ...
  : m_atEnd(false), m_support(p_support), 
    m_currentStrat(m_support.GetGame()->NumPlayers()),
    m_profile(m_support.GetGame()), m_frozen1(pl), m_frozen2(0)
{
...
StrategyIterator::StrategyIterator(const StrategySupport &p_support,
  ...
  : m_atEnd(false), m_support(p_support), 
    m_currentStrat(m_support.GetGame()->NumPlayers()),
    m_profile(m_support.GetGame()), m_frozen1(pl1), m_frozen2(pl2)
{
