...
template class gNode<gTreeNode<gPoly<double> >*>;
template class gTree<gPoly<double> >;
template class gList<gTree<gPoly<double> > >;
template class gNode<gTree<gPoly<double> > >;
