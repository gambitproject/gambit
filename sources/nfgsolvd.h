...
{
public:
    wxRadioBox *MakeNfgAlgorithmList(int num_players, bool const_sum, 
                                     wxPanel *parent, wxFunction func = 0)
    {
...
public:
        ...
        : NfgSolveSettings(nf, false)
    {
        ...
        nfg_algorithm_box = MakeNfgAlgorithmList(nf.NumPlayers(), 
                                                 IsConstSum(nf), d, 
                                                 (wxFunction)nfg_algorithm_box_func);
...
public:
        ...
        : NfgSolveSettings(nf, false), MyDialogBox(parent, "Standard Solution", NFG_STANDARD_HELP)
    {
        ...
        standard_type_str = new char[20];
        standard_num_str = new char[20];
