...
@pytest.mark.parametrize(
    ...
    [
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 0, 0, 0, 0),
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 0, 1, 0, 1),
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 1, 0, 1, 0),
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 1, 1, 1, 1),
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 2, 0, 2, 0),
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 2, 1, 2, 1),
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 0, 0, 0, 0),
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 0, 1, 0, 1),
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 1, 0, 2, 0),
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 1, 1, 2, 1),
...
@pytest.mark.parametrize(
    ...
    [
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 0, 0, 1),
...
@pytest.mark.parametrize(
    ...
    [
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 0, 1),
        (gbt.catalog.load("journals/ijgt/selten1975/fig1"), 1, 0),
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 0, 2),
        (gbt.catalog.load("journals/ijgt/selten1975/fig2"), 1, 0),
