...
LOCAL_GAMES_TO_TEST = [
    ...
    pytest.param(
        "vd.nfg",
        id="contrib games that converge to a NE (convex set of equilibria) - vd.nfg"
    ),
    pytest.param(
        "wink3.nfg",
        id="contrib games that converge to a NE - wink3.nfg"
    ),
    pytest.param(
        "g1.nfg",
        id="contrib games that converge to a NE - g1.nfg"
    ),
    pytest.param(
        "g2.nfg",
        id="contrib games that converge to a NE - g2.nfg (initial tangent goes negative)"
    ),
