...
% \\
Part of the \helpref{Gambit Project}{gambitproject}\\
...
The Gambit Graphics User Interface (Gambit \popref{GUI}{guigloss}) is an
...
A \popref{node}{nodegloss} is represented as a horizontal line.  Every
non-terminal node is a \popref{decision node}{decnodegloss} and is
represented by the color of the player who makes a decision at that
node.  Nodes are connected by \popref{branches}{branchgloss}, which
...
branch.  In gambit \popref{Outcomes}{outcomegloss} can be attached to
