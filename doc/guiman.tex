...
\subsubsection{Elimination of Dominated Strategies}\label{UnDominated}
\begin{figure}
...
\helpref{elimination of dominated strategies}{UnDominated} algorithm, 
...
\helpref{Select Support}{UnDominatedInspect} dialog, the newly created 
...
normal form game, in the \helpref{Solve->UnDominated}{UnDominated} menu.  
...
\helpref{eliminate dominated strategies}{UnDominated} from 
