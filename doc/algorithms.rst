...
It was shown by Shapley :cite:p:`Sha74` that there are equilibria not accessible via the method in :ref:`lcp`, whereas the output of
...
by this method, i.e., some equilibria are inaccessible; see Shapley :cite:p:`Sha74`.
