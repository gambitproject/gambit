...
class gnmgame {
 public:
  ...
  //virtual void KSymPayoffMatrix(cmatrix &dest, cvector &s, Number fuzz){PayoffMatrix(dest,s,fuzz);}

  //albert
  // generate random strat profile, with full support
  ...
  // generate random strat profile, with random support size.
