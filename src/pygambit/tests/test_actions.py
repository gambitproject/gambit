...
class TestGambitActions(unittest.TestCase):
    ...
    def test_action_probability(self):
        ...
        assert self.extensive_game.root.infoset.actions[0].prob == decimal.Decimal(
            "0.500000"
        )
        ...
        assert self.extensive_game.root.infoset.actions[0].prob == fractions.Fraction(
            "1/17"
        )
        ...
        self.failUnlessRaises(
            TypeError, setattr, self.extensive_game.root.infoset.actions[0], "prob", 2.0
        )
        self.failUnlessRaises(
            TypeError,
            setattr,
