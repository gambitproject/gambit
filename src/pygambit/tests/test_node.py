...
class TestGambitNode(unittest.TestCase):
    ...
    def test_get_infoset(self):
        ...
        assert (
            self.extensive_game.root.children[0].children[1].children[0].infoset == None
        )

    def test_get_outcome(self):
        "Test to ensure that we can retrieve an outcome for a given node"
        assert (
            self.extensive_game.root.children[0].children[1].children[0].outcome
            == self.extensive_game.outcomes[1]
        )
    ...
    def test_get_player(self):
        ...
        assert (
            self.extensive_game.root.children[0].children[1].children[0].player == None
        )
    ...
    def test_is_terminal(self):
        ...
        assert (
            self.extensive_game.root.children[0].children[0].children[0].is_terminal
            == True
        )
    ...
    def test_is_successor_of(self):
        ...
        self.assertRaises(TypeError, self.extensive_game.root.is_successor_of, 9)
        self.assertRaises(TypeError, self.extensive_game.root.is_successor_of, "Test")
        self.assertRaises(
            TypeError,
            self.extensive_game.root.is_successor_of,
    ...
    def test_append_move_error_player_mismatch(self):
        ...
        self.assertRaises(
            MismatchError, self.game.root.append_move, self.extensive_game.players[0], 1
        )
    ...
    def test_insert_move_error_player_mismatch(self):
        "Test to ensure the node and the player are from the same game"
        self.assertRaises(
            MismatchError, self.game.root.insert_move, self.extensive_game.players[0], 1
        )
    ...
    def test_node_copy_tree_error(self):
        ...
        self.assertRaises(
            MismatchError, self.game.root.copy_tree, self.extensive_game.root
        )
    ...
    def test_node_move_tree_error(self):
        ...
        self.assertRaises(
            MismatchError, self.game.root.move_tree, self.extensive_game.root
        )
