...
class TestGambitGame(unittest.TestCase):
    ...
    def test_game_get_outcome_with_bad_strings(self):
        ...
        self.game.players[0].strategies[0].label = "defect"
        self.game.players[1].strategies[0].label = "cooperate"
        self.assertRaises(IndexError, self.game.__getitem__, ("defect", "defect"))
    ...
    def test_game_get_outcome_with_strategies(self):
        ...
        assert (
            ...
            == self.game[
                self.game.players[0].strategies[0], self.game.players[1].strategies[0]
            ]
        )
    ...
    def test_strategic_game_actions_error(self):
        "Test to ensure an error is raised when trying to access actions " "of a game without a tree representation"
    ...
    def test_strategic_game_infosets_error(self):
        "Test to ensure an error is raised when trying to access infosets " "of a game without a tree representation"
    ...
    def test_game_get_root_error(self):
        "Test to ensure an error is raised when trying to get the root" "node of a game without a tree representation"
