...
class TestGambitEfgFile(unittest.TestCase):
    ...
    def test_parse_string_empty(self):
        ...
        self.assertEqual(
            str(e.exception), "Parse error in game file: line 1:2: Expecting file type"
        )
    ...
    def test_parse_string_wrong_magic(self):
        ...
        self.assertEqual(
            str(e.exception), "Parse error in game file: line 1:3: Expecting file type"
        )
    ...
    def test_parse_string_node_type(self):
        ...
        with self.assertRaises(ValueError) as e:
            pygambit.Game.parse_game(ft)
        self.assertEqual(
            str(e.exception), "Parse error in game file: line 4:3: Invalid type of node"
        )
...
class TestGambitNfgFile(unittest.TestCase):
    ...
    def test_parse_string_removed_title(self):
        ...
        with self.assertRaises(ValueError) as e:
            pygambit.Game.parse_game(ft)
        self.assertEqual(
            str(e.exception), "Parse error in game file: line 1:11: Game title missing"
        )
    ...
    def test_parse_string_removed_player(self):
        ...
        self.assertEqual(
            str(e.exception),
            "Parse error in game file: line 1:73: Not enough players for number of strategy entries",
        )
