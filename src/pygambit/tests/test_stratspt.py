...
class TestGambitStrategicRestriction(unittest.TestCase):
    def setUp(self):
        ...
        self.tree_game = pygambit.Game.read_game("test_games/mixed_behavior_game.efg")
    ...
    def test_unrestricting_strategies(self):
        ...
        for i in range(0, len(self.restriction.strategies) - 1):
            assert (
                self.restriction.strategies[i].unrestrict() == self.game.strategies[i]
            )
    ...
    def test_restriction_add_outcome_error(self):
        "Test to ensure an error is raised when trying to add an outcome" "to a restriction"
        self.assertRaises(
            UndefinedOperationError, lambda: self.restriction.outcomes.add("")
        )

    def test_restriction_outcome_value_error(self):
        "Test to ensure an error is raised when trying to change the value" "of an outcome in a restriction"
    ...
    def test_restriction_outcome_label_error(self):
        "Test to ensure an error is raised when trying to change the label" "of an outcome in a restriction"
    ...
    def test_restriction_outcome_delete_error(self):
        "Test to ensure an error is raised when trying to delete an outcome" "in a restriction"
        self.assertRaises(
            UndefinedOperationError, lambda: self.restriction.outcomes[0].delete()
        )

    def test_restriction_add_player_error(self):
        "Test to ensure an error is raised when trying to add a player" "to a restriction"
        self.assertRaises(
            UndefinedOperationError, lambda: self.restriction.players.add("")
        )

    def test_restriction_player_label_error(self):
        "Test to ensure an error is raised when trying to change the label" "of a player in a restriction"
    ...
    def test_restriction_add_strategy_error(self):
        "Test to ensure an error is raised when trying to add a strategy" "to a restriction"
        self.assertRaises(
    ...
    def test_restriction_player_strategy_label_error(self):
        "Test to ensure an error is raised when trying to change the label" "of a player's strategy in a restriction"
