...
class TestGambitMixedBehavGame:
    ...
    def test_payoff(self):
        ...
        assert self.profile_rational.payoff(self.game.players[0]) == fractions.Fraction(
            3, 1
        )
        assert self.profile_rational.payoff(self.game.players[1]) == fractions.Fraction(
            3, 1
        )
        assert self.profile_rational.payoff(self.game.players[2]) == fractions.Fraction(
            13, 4
        )
    ...
    def test_get_probabilities_infoset(self):
        ...
        assert self.profile_rational[self.game.players[0].infosets[0]] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert (
        ...
        assert self.profile_rational[self.game.players[1].infosets[0]] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert (
        ...
        assert self.profile_rational[self.game.players[2].infosets[0]] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert (
    ...
    def test_get_probabilities_infoset_by_string(self):
        ...
        assert self.profile_rational[self.game.players[0]]["Infoset 1:1"] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert self.profile_rational["Infoset 1:1"] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert self.profile_rational[self.game.players[1]]["Infoset 2:1"] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert self.profile_rational["Infoset 2:1"] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert self.profile_rational[self.game.players[2]]["Infoset 3:1"] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
        assert self.profile_rational["Infoset 3:1"] == [
            fractions.Fraction("1/2"),
            fractions.Fraction("1/2"),
        ]
    ...
    def test_set_probabilities_infoset(self):
        ...
        assert self.profile_rational[self.game.players[0]][0] == [
            fractions.Fraction("2/9"),
            fractions.Fraction("7/9"),
        ]
        self.profile_rational[self.game.players[0]][0] = [
    ...
    def test_infoset_prob(self):
        ...
        assert self.profile_rational.realiz_prob(
    ...
    def test_infoset_prob_by_string(self):
        ...
        assert self.profile_rational.realiz_prob("Infoset 1:1") == fractions.Fraction(
            "1/1"
        )
        assert self.profile_rational.realiz_prob("Infoset 2:1") == fractions.Fraction(
            "1/1"
        )
        assert self.profile_rational.realiz_prob("Infoset 3:1") == fractions.Fraction(
            "1/1"
        )
    ...
    def test_infoset_payoff(self):
        ...
        assert self.profile_rational.payoff(
            self.game.players[0].infosets[0]
    ...
    def test_action_payoff(self):
        ...
        assert (
            self.profile_double.payoff(self.game.players[0].infosets[0].actions[0])
            == 3.0
        )
        assert (
            self.profile_double.payoff(self.game.players[0].infosets[0].actions[1])
            == 3.0
        )
        assert (
            self.profile_double.payoff(self.game.players[1].infosets[0].actions[0])
            == 3.0
        )
        assert (
            self.profile_double.payoff(self.game.players[1].infosets[0].actions[1])
            == 3.0
        )
        assert (
            self.profile_double.payoff(self.game.players[2].infosets[0].actions[0])
            == 3.5
        )
        assert (
            self.profile_double.payoff(self.game.players[2].infosets[0].actions[1])
            == 3.0
        )
    ...
    def test_regret(self):
        ...
        assert (
            self.profile_double.regret(self.game.players[0].infosets[0].actions[0])
            == 0.0
        )
        assert (
            self.profile_double.regret(self.game.players[0].infosets[0].actions[1])
            == 0.0
        )
        assert (
            self.profile_double.regret(self.game.players[1].infosets[0].actions[0])
            == 0.0
        )
        assert (
            self.profile_double.regret(self.game.players[1].infosets[0].actions[1])
            == 0.0
        )
        assert (
            self.profile_double.regret(self.game.players[2].infosets[0].actions[0])
            == 0.25
        )
        assert (
            self.profile_double.regret(self.game.players[2].infosets[0].actions[1])
            == -0.25
        )

        assert self.profile_rational.regret(
            self.game.players[0].infosets[0].actions[0]
    ...
    def test_node_belief(self):
        ...
        assert (
            abs(self.profile_double.belief(self.game.infosets[1].members[0]) - 0.8)
            < 1e-13
        )
        assert (
            abs(self.profile_double.belief(self.game.infosets[1].members[1]) - 0.2)
            < 1e-13
        )
        assert (
            abs(self.profile_double.belief(self.game.infosets[2].members[0]) - 0.32)
            < 1e-13
        )
        assert (
            abs(self.profile_double.belief(self.game.infosets[2].members[1]) - 0.48)
            < 1e-13
        )
        assert (
            abs(self.profile_double.belief(self.game.infosets[2].members[2]) - 0.08)
            < 1e-13
        )
        assert (
            abs(self.profile_double.belief(self.game.infosets[2].members[3]) - 0.12)
            < 1e-13
        )
        ...
        assert self.profile_rational.belief(
            self.game.infosets[1].members[0]
        ) == fractions.Fraction(4, 5)
        assert self.profile_rational.belief(
            self.game.infosets[1].members[1]
        ) == fractions.Fraction(1, 5)
        assert self.profile_rational.belief(
            self.game.infosets[2].members[0]
        ) == fractions.Fraction(8, 25)
        assert self.profile_rational.belief(
            self.game.infosets[2].members[1]
        ) == fractions.Fraction(12, 25)
        assert self.profile_rational.belief(
            self.game.infosets[2].members[2]
        ) == fractions.Fraction(2, 25)
        assert self.profile_rational.belief(
            self.game.infosets[2].members[3]
    ...
    def test_infoset_belief(self):
        ...
        assert self.profile_rational.belief(self.game.infosets[0])[
            0
        ] == fractions.Fraction(1, 1)
        for i in self.game.infosets:
