...
class TestGambitMixedStrategyGame(unittest.TestCase):
    ...
    def test_strategy_value(self):
        ...
        assert (
            self.profile_double.strategy_value(self.game.players[0].strategies[1])
            == 0.0
        )
        assert (
            self.profile_rational.strategy_value(self.game.players[0].strategies[1])
            == 0.0
        )
    ...
    def test_get_probabilities_player(self):
        ...
        assert self.profile_rational[self.game.players[0]][0] == fractions.Fraction(
            "1/2"
        )
    ...
    def test_set_probabilities(self):
        ...
        assert self.profile_rational[self.game.players[0]][1] == fractions.Fraction(
            "2/9"
        )
