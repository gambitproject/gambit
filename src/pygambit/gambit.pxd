...
cdef extern from "games/game.h":
    ...
    cdef cppclass c_GameOutcome "GameObjectSharedPtr<GameOutcomeRep>":
        ...
        bool operator !=(c_GameOutcome) except +
        shared_ptr[c_GameOutcomeRep] deref "operator->"() except +RuntimeError
    ...
    cdef cppclass c_GameInfoset "GameObjectSharedPtr<GameInfosetRep>":
        bool operator ==(c_GameInfoset) except +
        bool operator !=(c_GameInfoset) except +
        shared_ptr[c_GameInfosetRep] deref "operator->"() except +RuntimeError
