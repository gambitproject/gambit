...
public:
  ...
  */
  ...
  const TiXmlNode *
  FirstChild(const char *value) const; ///< The first child of this node with the matching 'value'.
                                       ///< Will be null if none found.
  TiXmlNode *FirstChild(const char *value); ///< The first child of this node with the matching
...
/**
   ...
   ).Child( "Child", i ).Element(); if ( !child ) break;
                // do something
                ++i;
        }
        @endverbatim
