...
class GameSequenceForm {
  ...
  Rational &GetTerminalProb(const std::map<GamePlayer, GameSequence> &p_profile)
  {
    return m_terminalProb.at(ProfileToIndex(p_profile), 1);
  }
