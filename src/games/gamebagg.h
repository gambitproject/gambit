...
public:
  ...
  Rational GetMinPayoff() const override { return (Rational)baggPtr->getExactMinPayoff(); }
  ...
  Rational GetMaxPayoff() const override { return (Rational)baggPtr->getExactMaxPayoff(); }
