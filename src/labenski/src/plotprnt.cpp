...
bool wxPlotPrintout::ShowPrintPreviewDialog(const wxString &frameTitle)
{
  ...
  wxPrintPreview *preview =
      new wxPrintPreview(new wxPlotPrintout(GetPlotCtrl(), GetTitle()),
  ...
  wxPreviewFrame *frame =
      new wxPreviewFrame(preview, GetPlotCtrl(), frameTitle, wxDefaultPosition, r.GetSize());
  frame->Centre(wxBOTH);
  frame->Initialize();
  frame->Show(true);
  return true;
