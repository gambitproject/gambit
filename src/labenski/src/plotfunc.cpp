...
wxObjectRefData *wxPlotFunction::CreateRefData() const { return new wxPlotFuncRefData; }
...
void wxPlotFunction::Destroy() { UnRef(); }

bool wxPlotFunction::Ok() const { return m_refData && M_PLOTFUNCDATA->m_parser.Ok(); }
