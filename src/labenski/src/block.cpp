...
static int wxCMPFUNC_CONV wxblockdouble_sort_topleft_bottomright(wxBlockDouble **a,
                                                                 wxBlockDouble **b)
{
...
static int wxCMPFUNC_CONV wxblockdouble_sort_topright_bottomleft(wxBlockDouble **a,
                                                                 wxBlockDouble **b)
{
  wxDouble y = ((*a)->m_y1 - (*b)->m_y1);
...
static int wxCMPFUNC_CONV wxblockdouble_sort_bottomleft_topright(wxBlockDouble **a,
                                                                 wxBlockDouble **b)
{
...
static int wxCMPFUNC_CONV wxblockdouble_sort_bottomright_topleft(wxBlockDouble **a,
                                                                 wxBlockDouble **b)
{
  wxDouble y = ((*a)->m_y2 - (*b)->m_y2);
...
static int wxCMPFUNC_CONV wxblockdouble_sort_largest_to_smallest(wxBlockDouble **a,
                                                                 wxBlockDouble **b)
{
  return (*a)->IsLarger(**b);
}
static int wxCMPFUNC_CONV wxblockdouble_sort_smallest_to_largest(wxBlockDouble **a,
                                                                 wxBlockDouble **b)
{
  return -(*a)->IsLarger(**b);
}
...
bool wxBlockInt::Combine(const wxBlockInt &b)
{
  ...
  if (((unionBlock.GetLeftTop() == GetLeftTop()) || (unionBlock.GetLeftTop() == b.GetLeftTop())) &&
      ((unionBlock.GetRightTop() == GetRightTop()) ||
       (unionBlock.GetRightTop() == b.GetRightTop())) &&
      ((unionBlock.GetLeftBottom() == GetLeftBottom()) ||
       (unionBlock.GetLeftBottom() == b.GetLeftBottom())) &&
      ((unionBlock.GetRightBottom() == GetRightBottom()) ||
       (unionBlock.GetRightBottom() == b.GetRightBottom()))) {
    *this = unionBlock;
    return true;
  }
...
bool wxBlockInt::Combine(const wxBlockInt &block, wxBlockInt &top, wxBlockInt &bottom,
...
bool wxBlockInt::Delete(const wxBlockInt &block, wxBlockInt &top, wxBlockInt &bottom,
                        wxBlockInt &left, wxBlockInt &right) const
{
  top = bottom = left = right = wxEmptyBlockInt;
...
bool wxBlockDouble::Combine(const wxBlockDouble &block, wxBlockDouble &top, wxBlockDouble &bottom,
...
bool wxBlockDouble::Delete(const wxBlockDouble &block, wxBlockDouble &top, wxBlockDouble &bottom,
                           wxBlockDouble &left, wxBlockDouble &right) const
{
  top = bottom = left = right = wxEmptyBlockDouble;
...
{
  wxCHECK_MSG((index >= 0) && (index < int(m_blocks.GetCount())), wxEmptyBlockInt,
              wxT("Invalid index"));
...
{
  wxCHECK_MSG((index >= 0) && (index < int(m_blocks.GetCount())), wxEmptyBlockDouble,
              wxT("Invalid index"));
  return m_blocks[index];
}
...
int wxBlockDoubleSelection::Index(wxDouble x, wxDouble y) const
{
  int n, count = m_blocks.GetCount();
  for (n = 0; n < count; n++) {
    if ((x >= m_blocks[n].m_x1) && (y >= m_blocks[n].m_y1) && (x <= m_blocks[n].m_x2) &&
        (y <= m_blocks[n].m_y2)) {
      return true;
    }
  }
...
void wxBlockDoubleSelectionIterator::Reset() { m_block_index = 0; }
