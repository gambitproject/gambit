...
#include "wx/wxthings/geometry.h"
...
wxCircleDouble::wxCircleDouble(const wxPoint2DDouble &p1, const wxPoint2DDouble &p2,
...
int wxCircleDouble::IntersectLine(const wxRay2DDouble &line, wxPoint2DDouble *pt1,
                                  wxPoint2DDouble *pt2) const
{
  ...
  wxDouble c = m_x * m_x + m_y * m_y + l1_x * l1_x + l1_y * l1_y -
               2.0 * (m_x * l1_x + m_y * l1_y) - m_r * m_r;
