...
wxSheetCellAttrRefData::wxSheetCellAttrRefData()
  : wxObjectRefData(),
    ...
    m_attrTypes(wxSHEET_AttrCell | wxSHEET_AttrAlignUnset), m_renderer(NULL), m_editor(NULL),
    m_defaultAttr(NULL)
{
}

wxSheetCellAttrRefData::wxSheetCellAttrRefData(const wxSheetCellAttrRefData &data)
  : wxObjectRefData(), m_foreColour(data.m_foreColour), m_backColour(data.m_backColour),
    m_font(data.m_font), m_attrTypes(data.m_attrTypes)
{
...
wxObjectRefData *wxSheetCellAttr::CreateRefData() const { return new wxSheetCellAttrRefData; }
...
void wxSheetCellAttr::SetAlignment(int align) { SetType(align, wxSHEET_AttrAlignType_Mask); }
...
{
  SetType(allow ? wxSHEET_AttrOverflow : wxSHEET_AttrOverflowNot, wxSHEET_AttrOverflowType_Mask);
}
...
{
  SetType(isReadOnly ? wxSHEET_AttrReadOnly : wxSHEET_AttrReadWrite, wxSHEET_AttrReadType_Mask);
}
...
void wxSheetCellAttr::SetKind(wxSheetAttr_Type kind) { SetType(kind, wxSHEET_AttrAny); }
...
bool wxSheetCellAttr::HasLevel() const { return HasType(wxSHEET_AttrLevelType_Mask); }
bool wxSheetCellAttr::HasOverflowMode() const { return HasType(wxSHEET_AttrOverflowType_Mask); }
...
bool wxSheetCellAttr::HasReadWriteMode() const { return HasType(wxSHEET_AttrReadType_Mask); }
...
bool wxSheetCellAttr::IsComplete() const
{
  return Ok() && HasForegoundColour() && HasBackgroundColour() && HasFont() && HasAlignment() &&
         HasOverflowMode() && HasLevel() && HasReadWriteMode() && HasRenderer() && HasEditor();
}
...
{
  wxCHECK_MSG(m_refData, wxSHEET_AttrAlignLeft | wxSHEET_AttrAlignCenterVert,
                                                 ...
                                                 wxSheetAttr_Type type)
{
  ...
  case wxSHEET_CELL_GRID: {
    ...
    case wxSHEET_AttrCell:
      return m_cellAttrs.GetValue(coords);
    case wxSHEET_AttrRow:
      return m_rowAttrs.GetValue(coords.GetRow());
    case wxSHEET_AttrCol:
      return m_colAttrs.GetValue(coords.GetCol());
    default:
      // unused as yet...
  ...
  case wxSHEET_CELL_ROWLABEL:
    return m_rowLabelAttrs.GetValue(coords.m_row);
  case wxSHEET_CELL_COLLABEL:
    return m_colLabelAttrs.GetValue(coords.m_col);
  default:
    wxFAIL_MSG(
        wxString::Format(wxT("Unhandled coords (%d, %d) in wxSheetCellAttrProvider::GetAttr"),
...
void wxSheetCellAttrProvider::SetAttr(const wxSheetCoords &coords, const wxSheetCellAttr &attr,
                                      wxSheetAttr_Type type)
{
  switch (wxSheet::GetCellCoordsType(coords)) {
  case wxSHEET_CELL_GRID: {
  ...
  default:
    wxFAIL_MSG(
        wxString::Format(wxT("Unhandled coords (%d, %d) in wxSheetCellAttrProvider::SetAttr"),
                         coords.m_row, coords.m_col));
    break;
  }
}
