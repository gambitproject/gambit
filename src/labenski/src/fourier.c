...
int fft_double(unsigned NumSamples, int InverseTransform, double *RealIn, double *ImagIn,
...
int fft_float(unsigned NumSamples, int InverseTransform, float *RealIn, float *ImagIn,
