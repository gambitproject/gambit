...
static const char *s_overflow_arrow_xpm_data[] = {
    ...
    "4 6 2 1", "  c None", "a c Black",
    /* pixels */
    "aa  ", "aaa ", "aaaa", "aaaa", "aaa ", "aa  "};
...
void wxSheetCellRenderer::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
...
wxSize wxSheetCellRenderer::GetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
...
void wxSheetCellRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                                      const wxRect &rect, const wxSheetCoords &UNUSE(coords),
                                      bool isSelected)
{
...
wxSize wxSheetCellRendererRefData::GetBestSize(wxSheet &sheet,
                                               ...
                                               wxDC &WXUNUSED(dc), const wxSheetCoords &coords)
{
...
void wxSheetCellStringRendererRefData::SetTextColoursAndFont(wxSheet &sheet,
                                                             const wxSheetCellAttr &attr, wxDC &dc,
                                                             bool isSelected)
{
...
wxSize wxSheetCellStringRendererRefData::DoGetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr,
...
wxSize wxSheetCellStringRendererRefData::GetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr,
                                                     wxDC &dc, const wxSheetCoords &coords)
{
  return DoGetBestSize(sheet, attr, dc, GetString(sheet, coords));
}

void wxSheetCellStringRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
...
void wxSheetCellStringRendererRefData::DoDraw(wxSheet &sheet, const wxSheetCellAttr &attr,
    ...
    if ((best_width > rectCell.width) && (col < num_cols - 1) && sheet.GetTable()) {
      ...
      for (cell.m_col = col + cell_cols; cell.m_col < num_cols; cell.m_col++) {
        ...
        for (cell.m_row = row; cell.m_row < row + cell_rows; cell.m_row++) {
          ...
          if (sheet.GetTable()->HasValue(ownerCell) || (ownerCell == editorCell)) {
            is_empty = false;
            break;
          }
        }
...
void wxSheetCellAutoWrapStringRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr,
                                                    wxDC &dc, const wxRect &rectCell,
                                                    const wxSheetCoords &coords, bool isSelected)
{
  wxSheetCellRendererRefData::Draw(sheet, attr, dc, rectCell, coords, isSelected);
  ...
  sheet.DrawTextRectangle(dc, GetTextLines(sheet, dc, attr, rect, coords), rect, align);
}

wxArrayString wxSheetCellAutoWrapStringRendererRefData::GetTextLines(wxSheet &sheet, wxDC &dc,
...
void wxSheetCellNumberRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                                            const wxRect &rectCell, const wxSheetCoords &coords,
                                            bool isSelected)
{
  wxSheetCellRendererRefData::Draw(sheet, attr, dc, rectCell, coords, isSelected);
...
void wxSheetCellFloatRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                                           const wxRect &rectCell, const wxSheetCoords &coords,
                                           bool isSelected)
{
  wxSheetCellRendererRefData::Draw(sheet, attr, dc, rectCell, coords, isSelected);
  ...
  if (params.IsEmpty()) {
    ...
    if (!tmp.IsEmpty()) {
      ...
      if (tmp.ToLong(&width)) {
        ...
        wxLogDebug(_T("Invalid wxSheetCellFloatRenderer width parameter string '%s ignored"),
                   params.c_str());
      }
    }
    ...
    if (!tmp.IsEmpty()) {
      ...
      if (tmp.ToLong(&precision)) {
        ...
        wxLogDebug(_T("Invalid wxSheetCellFloatRenderer precision parameter string '%s ignored"),
                   params.c_str());
      }
    }
  }
...
wxSize wxSheetCellBitmapRendererRefData::GetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr,
                                                     wxDC &dc, const wxSheetCoords &coords)
{
  wxSize bmpSize;
  if (m_bitmap.Ok()) {
...
void wxSheetCellBitmapRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                                            const wxRect &rect_, const wxSheetCoords &coords,
                                            bool isSelected)
{
...
wxSize wxSheetCellBoolRendererRefData::GetBestSize(wxSheet &sheet,
                                                   const wxSheetCellAttr &WXUNUSED(attr),
                                                   wxDC &WXUNUSED(dc), const wxSheetCoords &)
{
...
void wxSheetCellBoolRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
...
void wxSheetCellDateTimeRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr,
                                              wxDC &dc, const wxRect &rectCell,
                                              const wxSheetCoords &coords, bool isSelected)
{
  wxSheetCellRendererRefData::Draw(sheet, attr, dc, rectCell, coords, isSelected);
...
wxString wxSheetCellEnumRendererRefData::GetString(wxSheet &sheet, const wxSheetCoords &coords)
{
  wxSheetTable *table = sheet.GetTable();
  if (table && table->CanGetValueAs(coords, wxSHEET_VALUE_NUMBER)) {
...
void wxSheetCellEnumRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                                          const wxRect &rectCell, const wxSheetCoords &coords,
                                          bool isSelected)
{
  wxSheetCellRendererRefData::Draw(sheet, attr, dc, rectCell, coords, isSelected);
...
void wxSheetCellRolColLabelRendererRefData::Draw(wxSheet &sheet, const wxSheetCellAttr &attr,
                                                 wxDC &dc, const wxRect &rectCell,
                                                 const wxSheetCoords &coords, bool isSelected)
{
