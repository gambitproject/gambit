...
#elif defined(__GNUG__) || defined(__GNUWIN32__) || defined(__DJGPP__) || defined(__SGI_CC__) ||  \
    defined(__SUNCC__) || defined(__XLC__) || defined(__HPUX__) || defined(__MWERKS__)
...
bool wxSpinCtrlDbl::Create(wxWindow *parent, wxWindowID id, const wxString &value,
                           const wxPoint &pos, const wxSize &size, long style, double min,
                           double max, double initial, double increment, int digits,
                           const wxString &name)
{
  ...
  m_textCtrl = new wxSpinCtrlDblTextCtrl(
