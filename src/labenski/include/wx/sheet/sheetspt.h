...
public:
  ...
  wxSheetSplitter(wxWindow *parent, wxWindowID id, const wxPoint &pos = wxDefaultPosition,
                  const wxSize &size = wxDefaultSize, long style = wxSP_3D | wxSP_3DBORDER,
...
public:
  ...
  wxSheetSplitterEvent(const wxSheetSplitterEvent &event)
    : wxNotifyEvent(event), m_sash_pos(event.m_sash_pos), m_vert_split(event.m_vert_split)
  {
  }
  ...
  wxSheetSplitter *GetSheetSplitter() const
  {
    return wxDynamicCast(GetEventObject(), wxSheetSplitter);
  }
...
#define EVT_SHEET_SPLIT_BEGIN(id, fn)                                                             \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_SPLIT_BEGIN, id, wxID_ANY,                                \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetSplitterEventFunction, &fn),                               \
                            NULL),
#define EVT_SHEET_SPLIT_CHANGING(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_SPLIT_CHANGING, id, wxID_ANY,                             \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetSplitterEventFunction, &fn),                               \
                            NULL),
#define EVT_SHEET_SPLIT_CHANGED(id, fn)                                                           \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_SPLIT_CHANGED, id, wxID_ANY,                              \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetSplitterEventFunction, &fn),                               \
                            NULL),
#define EVT_SHEET_SPLIT_DOUBLECLICKED(id, fn)                                                     \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_SPLIT_DOUBLECLICKED, id, wxID_ANY,                        \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetSplitterEventFunction, &fn),                               \
                            NULL),
#define EVT_SHEET_SPLIT_UNSPLIT(id, fn)                                                           \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_SPLIT_UNSPLIT, id, wxID_ANY,                              \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetSplitterEventFunction, &fn),                               \
                            NULL),
#define EVT_SHEET_SPLIT_CREATE_SHEET(id, fn)                                                      \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_SPLIT_CREATE_SHEET, id, wxID_ANY,                         \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetSplitterEventFunction, &fn),                               \
                            NULL),
