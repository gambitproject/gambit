...
public:
  ...
  wxColour m_foreColour, m_backColour;
  wxFont m_font;
...
WX_DECLARE_OBJARRAY_WITH_DECL(wxSheetCellAttr, wxArraySheetCellAttr, class WXDLLIMPEXP_SHEET);
// Create the paired array of attrs for row/col labels
DECLARE_PAIRED_INT_DATA_ARRAYS(wxSheetCellAttr, wxArraySheetCellAttr, wxPairArrayIntSheetCellAttr,
...
public:
  ...
  virtual wxSheetCellAttr GetAttr(const wxSheetCoords &coords, wxSheetAttr_Type type);
...
protected:
  ...
  wxPairArrayIntSheetCellAttr m_rowAttrs, m_colAttrs, m_rowLabelAttrs, m_colLabelAttrs;
