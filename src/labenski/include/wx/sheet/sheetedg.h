...
DECLARE_PAIRED_INT_DATA_ARRAYS(int, wxArrayInt, wxPairArrayIntInt, class WXDLLIMPEXP_SHEET)
...
public:
  ...
  wxSheetArrayEdge(size_t count = 0, size_t default_size = 1, size_t min_allowed_size = 0);
