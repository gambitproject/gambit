...
public:
  wxSheetChildWindow(wxSheet *parent, wxWindowID id = wxID_ANY,
                     ...
                     long style = wxWANTS_CHARS | wxBORDER_NONE |
                                  wxCLIP_CHILDREN, //|wxFULL_REPAINT_ON_RESIZE ) // FIXME
...
public:
  ...
  wxSheet(wxWindow *parent, wxWindowID id, const wxPoint &pos = wxDefaultPosition,
          const wxSize &size = wxDefaultSize, long style = wxWANTS_CHARS,
          const wxString &name = wxT("wxSheet"))
    : wxWindow(), m_gridWin(NULL)
  {
    Init();
  ...
  {
    return (coords.m_row >= -1) && (coords.m_col >= -1) && (coords.m_row < GetNumberRows()) &&
  ...
  {
    return GetSheetRefData()->m_rowEdges.GetMinAllowedSize();
  }
  int GetMinimalAcceptableColWidth() const
  {
    return GetSheetRefData()->m_colEdges.GetMinAllowedSize();
  }
  void SetMinimalAcceptableRowHeight(int height)
  {
    GetSheetRefData()->m_rowEdges.SetMinAllowedSize(height);
  }
  void SetMinimalAcceptableColWidth(int width)
  {
    GetSheetRefData()->m_colEdges.SetMinAllowedSize(width);
  }
  ...
  {
    GetSheetRefData()->m_rowEdges.SetMinSize(row, height);
  }
  void SetMinimalColWidth(int col, int width)
  {
    GetSheetRefData()->m_colEdges.SetMinSize(col, width);
  }
  ...
  {
    SetDragCellSize(wxSHEET_DragLabelRowHeight, enable);
  }
  void EnableDragColSize(bool enable = true)
  {
    SetDragCellSize(wxSHEET_DragLabelColWidth, enable);
  }
  void EnableDragGridSize(bool enable = true)
  {
    SetDragCellSize(wxSHEET_DragGridCellSize, enable);
  }
  ...
  {
    return GetSheetRefData()->m_cursorCellHighlightColour;
  }
  int GetCursorCellHighlightPenWidth() const
  {
    return GetSheetRefData()->m_cursorCellHighlightPenWidth;
  }
  int GetCursorCellHighlightROPenWidth() const
  {
    return GetSheetRefData()->m_cursorCellHighlightROPenWidth;
  }
  ...
  {
    return GetSheetRefData()->m_selectionBackground;
  }
  const wxColour &GetSelectionForeground() const
  {
    return GetSheetRefData()->m_selectionForeground;
  }
  ...
  {
    return GetTable() ? GetTable()->GetSpannedBlocks() : NULL;
  }
  // ------------------------------------------------------------------------
  ...
  {
    return GetAttr(coords, wxSHEET_AttrAny);
  }
  ...
  {
    return GetAttr(coords, wxSHEET_AttrCell);
  }
  wxSheetCellAttr GetGridRowAttr(int row) const
  {
    return GetAttr(wxSheetCoords(row, 0), wxSHEET_AttrRow);
  }
  wxSheetCellAttr GetGridColAttr(int col) const
  {
    return GetAttr(wxSheetCoords(0, col), wxSHEET_AttrCol);
  }
  ...
  {
    SetAttr(coords, attr, wxSHEET_AttrCell);
  }
  void SetGridRowAttr(int row, const wxSheetCellAttr &attr)
  {
    SetAttr(wxSheetCoords(row, 0), attr, wxSHEET_AttrRow);
  }
  void SetGridColAttr(int col, const wxSheetCellAttr &attr)
  {
    SetAttr(wxSheetCoords(0, col), attr, wxSHEET_AttrCol);
  }
  ...
  {
    return GetAttr(wxSheetCoords(row, -1), wxSHEET_AttrAny);
  }
  wxSheetCellAttr GetColLabelAttr(int col) const
  {
    return GetAttr(wxSheetCoords(-1, col), wxSHEET_AttrAny);
  }
  wxSheetCellAttr GetCornerLabelAttr() const
  {
    return GetAttr(wxSheetCoords(-1, -1), wxSHEET_AttrAny);
  }
  ...
  {
    return GetAttr(wxSheetCoords(row, -1), wxSHEET_AttrCell);
  }
  wxSheetCellAttr GetColLabelCellAttr(int col) const
  {
    return GetAttr(wxSheetCoords(-1, col), wxSHEET_AttrCell);
  }
  ...
  {
    SetAttr(wxSheetCoords(row, -1), attr, wxSHEET_AttrCell);
  }
  void SetColLabelCellAttr(int col, const wxSheetCellAttr &attr)
  {
    SetAttr(wxSheetCoords(-1, col), attr, wxSHEET_AttrCell);
  }
  void SetCornerLabelAttr(const wxSheetCellAttr &attr)
  {
    SetAttr(wxSheetCoords(-1, -1), attr, wxSHEET_AttrCell);
  }
  ...
  {
    return GetAttr(coords, wxSHEET_AttrDefault);
  }
  wxSheetCellAttr GetDefaultGridCellAttr() const
  {
    return GetAttr(wxGridCellSheetCoords, wxSHEET_AttrDefault);
  }
  wxSheetCellAttr GetDefaultRowLabelAttr() const
  {
    return GetAttr(wxRowLabelSheetCoords, wxSHEET_AttrDefault);
  }
  wxSheetCellAttr GetDefaultColLabelAttr() const
  {
    return GetAttr(wxColLabelSheetCoords, wxSHEET_AttrDefault);
  }
  void SetDefaultAttr(const wxSheetCoords &coords, const wxSheetCellAttr &attr)
  {
    SetAttr(coords, attr, wxSHEET_AttrDefault);
  }
  void SetDefaultGridCellAttr(const wxSheetCellAttr &attr)
  {
    SetAttr(wxGridCellSheetCoords, attr, wxSHEET_AttrDefault);
  }
  void SetDefaultRowLabelAttr(const wxSheetCellAttr &attr)
  {
    SetAttr(wxRowLabelSheetCoords, attr, wxSHEET_AttrDefault);
  }
  void SetDefaultColLabelAttr(const wxSheetCellAttr &attr)
  {
    SetAttr(wxColLabelSheetCoords, attr, wxSHEET_AttrDefault);
  }
  ...
  {
    return GetSheetRefData()->m_defaultRowLabelAttr;
  }
  const wxSheetCellAttr &DoGetDefaultColLabelAttr() const
  {
    return GetSheetRefData()->m_defaultColLabelAttr;
  }
  ...
  const wxColour &GetAttrBackgroundColour(const wxSheetCoords &coords,
                                          wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  const wxColour &GetAttrForegoundColour(const wxSheetCoords &coords,
                                         wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  const wxFont &GetAttrFont(const wxSheetCoords &coords,
                            wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  int GetAttrAlignment(const wxSheetCoords &coords, wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  int GetAttrOrientation(const wxSheetCoords &coords,
                         wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  ...
  bool GetAttrOverflowMarker(const wxSheetCoords &coords,
                             wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  bool GetAttrShowEditor(const wxSheetCoords &coords,
                         wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  bool GetAttrReadOnly(const wxSheetCoords &coords, wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  wxSheetCellRenderer GetAttrRenderer(const wxSheetCoords &coords,
                                      wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  wxSheetCellEditor GetAttrEditor(const wxSheetCoords &coords,
                                  wxSheetAttr_Type type = wxSHEET_AttrAny) const;
  ...
  void SetAttrBackgroundColour(const wxSheetCoords &coords, const wxColour &colour,
                               wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrForegroundColour(const wxSheetCoords &coords, const wxColour &colour,
                               wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrFont(const wxSheetCoords &coords, const wxFont &font,
                   wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrAlignment(const wxSheetCoords &coords, int align,
                        wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrOrientation(const wxSheetCoords &coords, int orientation,
                          wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrLevel(const wxSheetCoords &coords, int level,
                    wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrOverflow(const wxSheetCoords &coords, bool allow,
                       wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrOverflowMarker(const wxSheetCoords &coords, bool draw_marker,
                             wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrShowEditor(const wxSheetCoords &coords, bool show_editor,
                         wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrReadOnly(const wxSheetCoords &coords, bool isReadOnly,
                       wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrRenderer(const wxSheetCoords &coords, const wxSheetCellRenderer &renderer,
                       wxSheetAttr_Type type = wxSHEET_AttrCell);
  void SetAttrEditor(const wxSheetCoords &coords, const wxSheetCellEditor &editor,
                     wxSheetAttr_Type type = wxSHEET_AttrCell);
  ...
  {
    SetCellValue(wxSheetCoords(row, -1), value);
  }
  void SetColLabelValue(int col, const wxString &value)
  {
    SetCellValue(wxSheetCoords(-1, col), value);
  }
  ...
  void RegisterDataType(const wxString &typeName, const wxSheetCellRenderer &renderer,
  ...
  {
    return DoMoveCursor(wxSheetCoords(-1, 0), expandSelection);
  }
  ...
  {
    return DoMoveCursor(wxSheetCoords(0, -1), expandSelection);
  }
  ...
  {
    return DoMoveCursorBlock(wxSheetCoords(-1, 0), expandSelection);
  }
  ...
  {
    return DoMoveCursorBlock(wxSheetCoords(0, -1), expandSelection);
  }
  ...
  {
    return DoMoveCursorUpDownPage(true, expandSelection);
  }
  bool MoveCursorDownPage(bool expandSelection)
  {
    return DoMoveCursorUpDownPage(false, expandSelection);
  }
  ...
  virtual bool SelectRows(int rowTop, int rowBottom, bool addToSelected = false,
                          bool sendEvt = false);
  virtual bool SelectCol(int col, bool addToSelected = false, bool sendEvt = false);
  virtual bool SelectCols(int colLeft, int colRight, bool addToSelected = false,
                          bool sendEvt = false);
  virtual bool SelectCell(const wxSheetCoords &coords, bool addToSelected = false,
                          bool sendEvt = false);
  ...
  virtual bool ToggleCellSelection(const wxSheetCoords &coords, bool addToSelected = false,
                                   bool sendEvt = false);
  ...
  {
    GetSheetRefData()->m_selectingBlock = selectingBlock;
  }
  void SetSelectingAnchor(const wxSheetCoords &selectingAnchor)
  {
    GetSheetRefData()->m_selectingAnchor = selectingAnchor;
  }
  ...
  {
    return GetSheetRefData()->m_cellEditorCoords;
  }
  ...
  // ------ control types
  enum { wxSHEET_TEXTCTRL = 2100, wxSHEET_CHECKBOX, wxSHEET_CHOICE, wxSHEET_COMBOBOX };
  ...
  int SendRangeEvent(const wxEventType type, const wxSheetBlock &block, bool selecting, bool add,
                     wxEvent *mouseOrKeyEvt = NULL);
  ...
  enum MouseCursorMode {
    ...
    WXSHEET_CURSOR_SELECTING =
        WXSHEET_CURSOR_SELECT_CELL | WXSHEET_CURSOR_SELECT_ROW | WXSHEET_CURSOR_SELECT_COL,
...
public:
  ...
  wxSheetEvent(const wxSheetEvent &event)
    : wxNotifyEvent(event), m_coords(event.m_coords), m_pos(event.m_pos),
      m_selecting(event.m_selecting), m_control(event.m_control), m_shift(event.m_shift),
...
public:
  wxSheetRangeSelectEvent(int id = 0, wxEventType type = wxEVT_NULL, wxObject *obj = NULL,
                          const wxSheetBlock &block = wxNullSheetBlock, bool sel = false,
...
#define EVT_SHEET_VIEW_CHANGED(id, fn)                                                            \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_VIEW_CHANGED, id, wxID_ANY,                                                     \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_SELECTING_CELL(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_SELECTING_CELL, id, wxID_ANY,                                                   \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_SELECTED_CELL(id, fn)                                                           \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_SELECTED_CELL, id, wxID_ANY,                                                    \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_LEFT_DOWN(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_LEFT_DOWN, id, wxID_ANY,                                                   \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_RIGHT_DOWN(id, fn)                                                         \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_RIGHT_DOWN, id, wxID_ANY,                                                  \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_LEFT_UP(id, fn)                                                            \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_LEFT_UP, id, wxID_ANY,                                                     \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_RIGHT_UP(id, fn)                                                           \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_RIGHT_UP, id, wxID_ANY,                                                    \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_LEFT_DCLICK(id, fn)                                                        \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_LEFT_DCLICK, id, wxID_ANY,                                                 \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_RIGHT_DCLICK(id, fn)                                                       \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_RIGHT_DCLICK, id, wxID_ANY,                                                \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_LABEL_LEFT_DOWN(id, fn)                                                         \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_LABEL_LEFT_DOWN, id, wxID_ANY,                                                  \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_LABEL_RIGHT_DOWN(id, fn)                                                        \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_LABEL_RIGHT_DOWN, id, wxID_ANY,                                                 \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_LABEL_LEFT_UP(id, fn)                                                           \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_LABEL_LEFT_UP, id, wxID_ANY,                                                    \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_LABEL_RIGHT_UP(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_LABEL_RIGHT_UP, id, wxID_ANY,                                                   \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_LABEL_LEFT_DCLICK(id, fn)                                                       \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_LABEL_LEFT_DCLICK, id, wxID_ANY,                                                \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_LABEL_RIGHT_DCLICK(id, fn)                                                      \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_LABEL_RIGHT_DCLICK, id, wxID_ANY,                                               \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_ROW_SIZE(id, fn)                                                                \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_ROW_SIZE, id, wxID_ANY,                                                         \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_COL_SIZE(id, fn)                                                                \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_COL_SIZE, id, wxID_ANY,                                                         \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_RANGE_SELECTING(id, fn)                                                         \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_RANGE_SELECTING, id, wxID_ANY,                            \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetRangeSelectEventFunction, &fn),                            \
                            NULL),
#define EVT_SHEET_RANGE_SELECTED(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_RANGE_SELECTED, id, wxID_ANY,                             \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetRangeSelectEventFunction, &fn),                            \
                            NULL),
#define EVT_SHEET_CELL_VALUE_CHANGING(id, fn)                                                     \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_VALUE_CHANGING, id, wxID_ANY,                                              \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_CELL_VALUE_CHANGED(id, fn)                                                      \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_CELL_VALUE_CHANGED, id, wxID_ANY,                                               \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_EDITOR_ENABLED(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_EDITOR_ENABLED, id, wxID_ANY,                                                   \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_EDITOR_DISABLED(id, fn)                                                         \
  DECLARE_EVENT_TABLE_ENTRY(                                                                      \
      wxEVT_SHEET_EDITOR_DISABLED, id, wxID_ANY,                                                  \
      (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxSheetEventFunction, &fn),       \
      NULL),
#define EVT_SHEET_EDITOR_CREATED(id, fn)                                                          \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_EDITOR_CREATED, id, wxID_ANY,                             \
                            (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(            \
                                wxSheetEditorCreatedEventFunction, &fn),                          \
                            NULL),
...
#define EVT_SHEET_CREATE_CELL(id, fn)                                                             \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_CREATE_CELL, id, wxID_ANY,                                \
                            (wxObjectEventFunction)(wxEventFunction)(wxSheetEventFunction) & fn,  \
                            NULL),
#define EVT_SHEET_CHANGE_LABELS(id, fn)                                                           \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_CHANGE_LABELS, id, wxID_ANY,                              \
                            (wxObjectEventFunction)(wxEventFunction)(wxSheetEventFunction) & fn,  \
                            NULL),
#define EVT_SHEET_CHANGE_SEL_LABEL(id, fn)                                                        \
  DECLARE_EVENT_TABLE_ENTRY(wxEVT_SHEET_CHANGE_SEL_LABEL, id, wxID_ANY,                           \
                            (wxObjectEventFunction)(wxEventFunction)(wxSheetEventFunction) & fn,  \
                            NULL),
