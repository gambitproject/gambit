...
public:
  ...
  void Draw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc, const wxRect &rect,
            const wxSheetCoords &coords, bool isSelected);

  // get the preferred size of the cell for its contents
  wxSize GetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
  ...
  wxSheetCellRenderer Clone() const
  {
    wxSheetCellRenderer obj;
    obj.Copy(*this);
    return obj;
  }
...
public:
  ...
  // get the preferred size of the cell for its contents
  virtual wxSize GetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                             const wxSheetCoords &coords);
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellRendererRefData, wxSheetCellRendererRefData)
};
...
public:
  ...
  void DoDraw(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc, const wxRect &rect,
              const wxSheetCoords &coords, bool isSelected);

  // set the text colours before drawing
  void SetTextColoursAndFont(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                             bool isSelected);

  // calc the string extent for given string/font
  wxSize DoGetBestSize(wxSheet &sheet, const wxSheetCellAttr &attr, wxDC &dc,
                       const wxString &text);
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellStringRendererRefData, wxSheetCellRendererRefData)
};
...
class WXDLLIMPEXP_SHEET wxSheetCellAutoWrapStringRendererRefData
  : public wxSheetCellStringRendererRefData {
public:
...
class WXDLLIMPEXP_SHEET wxSheetCellNumberRendererRefData
  : public wxSheetCellStringRendererRefData {
public:
  wxSheetCellNumberRendererRefData() {}
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellNumberRendererRefData, wxSheetCellRendererRefData)
};
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellFloatRendererRefData, wxSheetCellRendererRefData)
...
class WXDLLIMPEXP_SHEET wxSheetCellBitmapRendererRefData
  : public wxSheetCellStringRendererRefData {
public:
  wxSheetCellBitmapRendererRefData(const wxBitmap &bitmap = wxNullBitmap, int align = 0)
    : m_bitmap(bitmap), m_align(align)
  {
  }
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellBitmapRendererRefData, wxSheetCellRendererRefData)
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellBoolRendererRefData, wxSheetCellRendererRefData)
...
class WXDLLIMPEXP_SHEET wxSheetCellDateTimeRendererRefData
  : public wxSheetCellStringRendererRefData {
public:
  wxSheetCellDateTimeRendererRefData(wxString outFormat = wxDefaultDateTimeFormat, //_T("%c"),
    ...
    : m_outFormat(outFormat), m_inFormat(inFormat), m_dateTime(wxDefaultDateTime),
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellEnumRendererRefData, wxSheetCellRendererRefData)
protected:
...
// the default renderer for the cells containing string data
class WXDLLIMPEXP_SHEET wxSheetCellRolColLabelRendererRefData
  : public wxSheetCellStringRendererRefData {
public:
  wxSheetCellRolColLabelRendererRefData() {}
