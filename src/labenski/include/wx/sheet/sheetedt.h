...
public:
  ...
  void CreateEditor(wxWindow *parent, wxWindowID id, wxEvtHandler *evtHandler, wxSheet *sheet);
  ...
  wxSize GetBestSize(wxSheet &grid, const wxSheetCellAttr &attr, const wxSheetCoords &coords);
  // Show or hide the edit control, use the specified attributes to set
  // colours/fonts for it if attr is Ok.
  void Show(bool show, const wxSheetCellAttr &attr);
  // Draws the part of the cell not occupied by the control: the base class
  // version just fills it with background colour from the attribute
  void PaintBackground(wxSheet &grid, const wxSheetCellAttr &attr, wxDC &dc, const wxRect &rect,
...
public:
  ...
  virtual void CreateEditor(wxWindow *parent, wxWindowID id, wxEvtHandler *evtHandler,
                            wxSheet *sheet);
  ...
  virtual void PaintBackground(wxSheet &grid, const wxSheetCellAttr &attr, wxDC &dc,
  ...
  virtual bool EndEdit(const wxSheetCoords &WXUNUSED(coords), wxSheet *WXUNUSED(grid))
  {
    return false;
  }
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellEditorRefData, wxSheetCellEditorRefData)
...
public:
  ...
  virtual void PaintBackground(wxSheet &, const wxSheetCellAttr &, wxDC &, const wxRect &,
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellTextEditorRefData, wxSheetCellEditorRefData)
...
class WXDLLIMPEXP_SHEET wxSheetCellAutoWrapStringEditorRefData
  : public wxSheetCellTextEditorRefData {
public:
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellNumberEditorRefData, wxSheetCellEditorRefData)
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellFloatEditorRefData, wxSheetCellEditorRefData)
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellBoolEditorRefData, wxSheetCellEditorRefData)
...
public:
  ...
  wxSheetCellChoiceEditorRefData(size_t count = 0, const wxString choices[] = NULL,
                                 bool allowOthers = false);
  wxSheetCellChoiceEditorRefData(const wxArrayString &choices, bool allowOthers = false);
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellChoiceEditorRefData, wxSheetCellEditorRefData)
...
public:
  ...
  DECLARE_SHEETOBJREFDATA_COPY_CLASS(wxSheetCellEnumEditorRefData, wxSheetCellEditorRefData)
