...
#define wxSHEET_CHECKUPDATE_RET(pos, count, origcount)                                            \
  wxCHECK_RET((count == 0) || ((int(count) > 0) && (int(pos) <= int(origcount))) ||               \
              ...
              wxString::Format(wxT("Updating past end of array, pos %d count %d, orig count %d"), \
                               pos, count, origcount));
...
enum wxSheetUpdate_Type {
  ...
  wxSHEET_UpdateLabelValues =
      wxSHEET_UpdateRowLabelValues | wxSHEET_UpdateColLabelValues, // update the label containers
  ...
  wxSHEET_UpdateAttributes =
      wxSHEET_UpdateGridCellAttrs | wxSHEET_UpdateLabelAttrs, // update the attr container

  wxSHEET_UpdateSelection = 0x0100, // update the selection

  wxSHEET_UpdateAll = (wxSHEET_UpdateValues | wxSHEET_UpdateSpanned | wxSHEET_UpdateAttributes |
                       wxSHEET_UpdateSelection),
...
enum wxSheetAttrAlign_Type {
  ...
  wxSHEET_AttrAlignHoriz_Mask =
      (wxALIGN_LEFT | wxALIGN_RIGHT | wxALIGN_CENTER_HORIZONTAL | wxSHEET_AttrAlignHorizUnset),
  wxSHEET_AttrAlignVert_Mask =
      (wxALIGN_TOP | wxALIGN_BOTTOM | wxALIGN_CENTER_VERTICAL | wxSHEET_AttrAlignVertUnset)
};
...
enum wxSheetAttrLevel_Type {
  ...
  wxSHEET_AttrLevelType_Mask =
      (wxSHEET_AttrLevelBottom | wxSHEET_AttrLevelMiddle | wxSHEET_AttrLevelTop)
};
...
enum wxSheetAttrOverflowMarker_Type {
  ...
  wxSHEET_AttrOverflowMarkerType_Mask =
      (wxSHEET_AttrOverflowMarker | wxSHEET_AttrOverflowMarkerNot)
};
...
#define DECLARE_PAIREDSHEETCOORDS_DATA_ARRAYS(Tval, TvalArray, name, classexp)                    \
  DECLARE_PAIRED_DATA_ARRAYS_BASE(wxSheetCoords, wxArraySheetCoords, Tval, TvalArray, name,       \
                                  classexp)                                                       \
public:                                                                                           \
