...
WX_DECLARE_OBJARRAY(wxBlockInt, wxArrayBlockInt);
WX_DECLARE_OBJARRAY(wxBlockDouble, wxArrayBlockDouble);
WX_DECLARE_OBJARRAY(wxBlockIntSelection, wxArrayBlockIntSelection);
WX_DECLARE_OBJARRAY(wxBlockDoubleSelection, wxArrayBlockDoubleSelection);
...
public:
  ...
  {
    return (wxMax(m_x1, b.m_x1) <= wxMin(m_x2, b.m_x2)) &&
  ...
  // |          bottom           |
  // |---------------------------|
  bool Combine(const wxBlockInt &block, wxBlockInt &top, wxBlockInt &bottom, wxBlockInt &left,
  ...
  bool Delete(const wxBlockInt &block, wxBlockInt &top, wxBlockInt &bottom, wxBlockInt &left,
              wxBlockInt &right) const;
  ...
  inline bool operator!=(const wxBlockInt &b) { return !(*this == b); }
...
public:
  ...
  inline void Intersect(const wxBlockDouble &src1, const wxBlockDouble &src2,
                        wxBlockDouble *dest) const
  {
    dest->m_x1 = wxMax(src1.m_x1, src2.m_x1);
    dest->m_x2 = wxMin(src1.m_x2, src2.m_x2);
    dest->m_y1 = wxMax(src1.m_y1, src2.m_y1);
  ...
  inline void Union(const wxBlockDouble &src1, const wxBlockDouble &src2,
                    wxBlockDouble *dest) const
  {
    dest->m_x1 = wxMin(src1.m_x1, src2.m_x1);
    dest->m_x2 = wxMax(src1.m_x2, src2.m_x2);
  ...
  {
    wxDouble width = m_x2 - m_x1, height = m_y2 - m_y1, b_width = b.m_x2 - b.m_x1,
  ...
  // |          bottom           |
  // |---------------------------|
  bool Combine(const wxBlockDouble &block, wxBlockDouble &top, wxBlockDouble &bottom,
               wxBlockDouble &left, wxBlockDouble &right) const;

  // test removal of a portion or all of this contained in block returning the
  // remainder in top, bottom, left, right - each may be IsEmpty()
  // returns false if nothing to delete, this cell is not changed
  bool Delete(const wxBlockDouble &block, wxBlockDouble &top, wxBlockDouble &bottom,
              wxBlockDouble &left, wxBlockDouble &right) const;
  ...
  inline bool operator!=(const wxBlockDouble &b) { return !(*this == b); }
...
public:
  ...
  bool SelectBlock(const wxBlockInt &block, bool combineNow = true,
                   wxArrayBlockInt *addedBlocks = NULL);
  ...
  // wxBlockIntSelection& operator = (const wxBlockIntSelection& other) { Copy(other); return
  // *this; }
