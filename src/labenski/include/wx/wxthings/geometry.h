...
class WXDLLEXPORT wxRay2DDouble : public wxPoint2DDouble {
public:
  ...
  inline wxDouble GetDistanceToPoint(const wxPoint2DDouble &pt,
                                     wxPoint2DDouble *closestPt = NULL) const
  {
    ...
    /*
            ...
            //printf("distance %.9lf %.9lf %d\n\n", i.GetDistance(p), pb.GetDistance(p),
       int(pb==i));
    */
  ...
  bool Intersect(const wxRay2DDouble &other, wxPoint2DDouble &pt) const
  {
    ...
    pt.m_x =
        (m_slope * m_x - other.m_slope * other.m_x + other.m_y - m_y) / (m_slope - other.m_slope);
...
//-----------------------------------------------------------------------------
/*
class WXDLLEXPORT wxLine2DInt : wxRect2DInt
{
public :
...
} inline wxLine2DInt(const wxLine2DInt &line) { m_x = line.m_x; m_y = line.m_y; m_width =
line.m_width; m_height = line.m_height; }
    ...
    inline wxDouble GetYFromX(wxDouble x) const {return (wxDouble(m_height)/m_width)*(x-m_x) +
m_y;} inline wxDouble GetXFromY(wxDouble y) const {return (y-m_y)*(wxDouble(m_height)/m_width) +
m_x;}
    ...
    inline wxDouble GetDistanceToPoint(const wxPoint2DDouble &pt, wxPoint2DDouble *closestPt=NULL)
const
    {
...
public:
  ...
  inline wxCircleDouble(const wxPoint2DDouble &p1, const wxPoint2DDouble &p2,
  ...
  int IntersectLine(const wxRay2DDouble &line, wxPoint2DDouble *pt1 = NULL,
...
class WXDLLEXPORT wxCircleInt : public wxPoint2DInt {
public:
...
class WXDLLEXPORT wxEllipseInt {
public:
  ...
  inline bool GetPointInEllipse(wxInt32 x, wxInt32 y) const
  {
    ...
    return (((x - m_origin.m_x) * (x - m_origin.m_x)) / m_radius.m_x +
                ((y - m_origin.m_y) * (y - m_origin.m_y)) / m_radius.m_y <=
            1);
  }
