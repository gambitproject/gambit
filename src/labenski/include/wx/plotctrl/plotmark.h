...
public:
  ...
  wxPlotMarker(int marker_type, const wxRect2DDouble &rect, const wxSize &size,
               const wxGenericPen &pen, const wxGenericBrush &brush = wxNullGenericBrush,
  ...
  //   in pixels
  wxPlotMarker(int marker_type, const wxPoint2DDouble &pt, const wxSize &size,
               const wxGenericPen &pen, const wxGenericBrush &brush = wxNullGenericBrush)
    : wxObject()
  {
  ...
  void Create(int marker_type, const wxRect2DDouble &rect, const wxSize &size,
              const wxGenericPen &pen, const wxGenericBrush &brush = wxNullGenericBrush,
              const wxBitmap &bitmap = wxNullBitmap);
  ...
  {
    Create(wxPLOTMARKER_BITMAP, wxRect2DDouble(pt.m_x, pt.m_y, 0, 0), wxSize(-1, -1),
           wxNullGenericPen, wxNullGenericBrush, bitmap);
  }
  ...
  // operators
  bool operator==(const wxPlotMarker &pm) const { return m_refData == pm.m_refData; }
  bool operator!=(const wxPlotMarker &pm) const { return m_refData != pm.m_refData; }
