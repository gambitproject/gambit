...
public:
  ...
  std::list<MixedStrategyProfile<Rational>> Solve(const MixedStrategyProfile<Rational> &p_start) const;
...
/// for an equilibrium.
///
std::list<MixedStrategyProfile<Rational>> NashSimpdivStrategySolver::Solve(const Game &p_game) const
{
