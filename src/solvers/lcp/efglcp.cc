...
template <class T>
std::list<MixedBehaviorProfile<T>> LcpBehaviorSolve(const Game &p_game, int p_stopAfter, int p_maxDepth,
...
template std::list<MixedBehaviorProfile<Rational>> LcpBehaviorSolve(const Game &, int, int,
