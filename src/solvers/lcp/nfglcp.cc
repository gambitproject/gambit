...
template <class T>
std::list<MixedStrategyProfile<T>> LcpStrategySolve(const Game &p_game, int p_stopAfter, int p_maxDepth,
...
template std::list<MixedStrategyProfile<Rational>> LcpStrategySolve(const Game &, int, int,
