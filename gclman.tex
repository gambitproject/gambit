...
\item
\protect \large \begin{verbatim}
IsNash[strategy->MIXED(T)] =: BOOLEAN
\end{verbatim}\normalsize

\bd Returns whether the mixed strategy profile \verb+strategy+ is a
Nash equilibrium of the corresponding normal form game.
\ed
...
\item
\protect \large \begin{verbatim}
LiapValue[strategy->MIXED(T)] =: T
\end{verbatim} \normalsize

\bd
Returns the Liapunov function value for the mixed strategy profile
\verb+strategy+.  This value is zero exactly when the profile is a
Nash equilibrium of the normal form game.
\ed
