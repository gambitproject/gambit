...
equivalents:\marginpar[]{The changes to {\tt Concat} and {\tt Power} are
pending}
...
\marginpar{The vector versions of these functions are pending.}
\begin{verbatim}
...
\marginpar{This function is pending.}
\bd
...
\marginpar{This function is part of the proposed subgame interface.}
\bd
...
\marginpar{This function is pending}
\bd
Returns the difference of $x$ and $y$, where the lists are treated
as vectors.  Lists of any dimensionality may be added; but it is a
run-time error if the lists do not have exactly the same
dimensionality.
\item
[Short form:] \verb%x - y%
\ed
...
\marginpar{This function is pending.}
\bd
Returns the sum of $x$ and $y$, where the lists are treated as vectors.
Lists of any dimensionality may be added; but it is a run-time error
if the lists do not have exactly the same dimensionality.
\item
[Short form:] \verb%x + y%
\item
[Note:] This function is new in version 0.92.  The function {\tt Plus}
from earlier versions has been renamed {\tt Concat}.
\ed
