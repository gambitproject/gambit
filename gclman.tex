...
Integer[x->LIST(NUMBER)] =: LIST(INTEGER)
\end{verbatim} \normalsize

\marginpar{This prototype is a proposed change to the pseudotype {\tt NUMBER}}
\bd
Converts \verb+x+ into a value of type \verb+INTEGER+, or a list of
numbers \verb+x+ into a list of \verb+INTEGER+s componentwise.
\item
...
\item
[Note:] If \verb+start->BEHAV+ is specified, subgame markings are ignored,
and solution by normal form is not available in the current version.
\ed
