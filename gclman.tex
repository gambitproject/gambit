...
\item
\protect \large \begin{verbatim}
AppendNode[n->NODE, pl->INTEGER, br->INTEGER, {acts->LIST(TEXT)},
	   {probs->LIST(T)}] =: NODE
\end{verbatim} \normalsize
...
\bd
\item
[acts:] A list of names for the actions at the newly-created information set
\item
[probs:] A list of probabilities for the actions.  This may only be specified
if the player is the chance player (player number 0)
\ed
\ed
...
\bd
\item
[Description:] Prints the specified normal form game as a list of
...
game which is to be used in displaying the game.  If not
...
\bd
\item
[N:] The game in normal form for which dominated strategies are to
be eliminated.
\ed
...
\item
\protect \large \begin{verbatim}
Enum[N->NFG, {nequilib->INTEGER},{trace->INTEGER}
{time<->RATIONAL},{output->TEXT}] =: LIST(MIXED)
\end{verbatim}\normalsize

\bd
\item
[Description:] Finds all Nash equilibria for a two person game.  More
...
\bd
\item
[N:] The game in normal form for which the solutions are to be found.  
\ed
...
\bd
\item
[nequilib:] Specifies the maximum number of equilibria to find.  If
...
\bd
\item
[N:] The game in normal form for which the Gobit solution is to be
found.
\item	
[E:] The game in extensive form for which the Gobit solution is to
be found.
\ed
...
\bd
\item  
[N:] The game in normal form which is to be operated on.
\ed
...
strategy in the given game in normal form.  Uses only strategies in
...
\bd
\item
[Description:] Searches for equilibria of the specified normal form
...
\bd
\item
[N:] The game in normal form for which the solution is to be
searched.
\ed
...
\bd
\item
[nequilib:] Specifies the number of equilibria to find.  If not specified,
...
\bd
\item
[N:] The game in normal form for which the Liapunov solution is to
be found.
\item
[E:] The game in extensive form for which the Liapunov solution is
to be found.
\ed
...
\protect \large \begin{verbatim}
MergeInfosets[n->LIST(NODE)] =: INFOSET
\end{verbatim}\normalsize
...
\bd
\item
[E:] The game in extensive form of which the behavioral profile is
to be a subvariable.
\item
...
\item
\protect \large \begin{verbatim}
NewEfg[{players->LIST(TEXT)}, {type->DATATYPE}] =: EFG
\end{verbatim}\normalsize
...
\bd
\item
[players:] A list of text names for the players to create by default.  If
...
the specified game in extensive form.  Note that outcomes are
...
\bd
\item
[E:] The game in extensive form for which a new outcome is to be
created.
\ed
...
specified player in the given game in extensive form.
\item
...
\bd
\item
[E:] The game in extensive form in which the information sets for
...
\bd
\item
[E:] The game in extensive form in which the number of nodes are to
be counted.
\ed
...
\bd
\item
[E:] The game in extensive form in which the number of outcomes is
to be found.
\ed
...
\bd
\item
[N:] The game in normal form in which the number of outcomes is to
be found.
\ed
...
\bd
\item
[E:] The game in extensive form in which the number of players is
to be found.
\ed
...
\bd
\item
[N:] The normal form game in which the number of strategies for the
...
\bd
\item
[N:] The game in normal form for which the weak pure strategy Nash
...
\item
\protect \large \begin{verbatim}
ReadNfg[file->TEXT, {type->DATATYPE}] =: NFG
\end{verbatim}\normalsize
...
game in extensive form.  If a game is not specified, the first game
is used by default.
\item
...
\bd
\item
[E:] The game in extensive form in which the root node is to be
found.
\ed
...
\bd
\item
[N:] The game in normal form on which the operation will be
performed.
\ed
...
\item
[Return value:] Returns the same extensive form game.
\item
[Required parameters:]\hfil\null

\bd
\item
[E:] The game in extensive form which is to be written to the
indicated file.
\item
[file:] The name of the file to which the extensive form game is to
be written.
\ed
\ed
...
\bd
\item
[N:] The game in normal form which is to be written to the
indicated file.

\item
[file:] The name of the file to which the normal form game is
to be written.
\ed
\ed
